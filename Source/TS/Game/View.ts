...
namespace Tetris {
    ...
    export class GameView {
        ...
        protected createShape(shapeType: string): void {
            ...
            let numberCols = 3;
            let arr: any[] = this.numbOfCol(indexRand, shapeType);
            color = arr[0];
            numberCols = arr[1];
        ...
        protected numbOfCol(indexRand: number, shapeType: string): any[] {
            let color = "";
            let numberCols = 3;
            switch (shapeType) {
                case "Sshape":
        ...
        public rotateForm(): void {
            ...
            if (this.checkMoveDown()) {
                ...
                let numberOfBoxes = arrayPos.length;
                let numberCols = 3;
                let arr: any[] = this.numbOfCol(indexRand, this.shapeType);
                color = arr[0];
                numberCols = arr[1];
